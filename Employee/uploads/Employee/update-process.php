...
if($update_action == 'course'){
   ...
   $query = "UPDATE Course set course_id = '$course_id',course_name = '$course_name',course_specialization = '$course_specialization',start_date = '$start_date', end_date = '$end_date',quarter = '$quarter', month = '$month', year = '$year',no_of_days = '$no_of_days',hours_per_day = '$hours_per_day', total_hours = '$total_hours',contract_location = '$contract_location',instructor_1 = '$instructor_1',hours_instructor_1 = '$hours_instructor_1',instructor_2 = '$instructor_2',hours_instructor_2 = '$hours_instructor_2' WHERE course_id='$course_id'";
