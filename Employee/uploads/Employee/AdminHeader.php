...
if (! empty($_SESSION["username"])) {
    $displayProfile=$_SESSION['username'];
    $validlogin="true";
}
else{
  $displayProfile="Admin Login";
  $validlogin="false";
      ...
      <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        <a class="navbar-brand" href="index.php">Employee</a>
            ...
            <li class="nav-item" style=" list-style-type: none;">
              <?php if(strcmp($validlogin,"true")){
            ?><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal"><?php  echo $displayProfile; ?> </button>
          <?php }else{


            ?><button type="button" class="btn btn-primary" data-placement="bottom" title="logout" data-toggle="modal" data-target="#logoutModal">Welcome, <?php  echo $displayProfile; ?> </button>
          <?php
          }
?>
